        ...
        <div className='container'>
            ...
            <div className='card shadow' style={{ width: '40rem' }}>
                <div style={{ marginLeft: '20px' }}>
                    <button className="btn btn-light" style={{ width: "55%", marginTop: "1rem" }}>
                        <img
                    ...
                    <div>
                        <p><b>Caption: </b> Lorem ipsum dolor sit amet consectetur adipisicing elit. Id, nesciunt!
                        </p>
                    </div>
                    <div className=''>
                    ...
                    <div>
                        <button className='btn' style={{ width: '100%' }}>
                            <div style={{ float: "left" }}>
                                <font className='my-3'>Liked by  {likes}</font><br />
                                <button className='btn btn-light' onClick={() => { setLikes(likes + 1) }}><i class="fa-regular fa-thumbs-up fa-lg"></i><font className='mx-3'>Like</font></button>
                            </div>
                            <div style={{ float: "left", marginLeft: "20px" }}>
                                <font className='my-3'>{comments} Comments</font><br />
                                <button className='btn btn-light' onClick={() => { setComment(comments + 1) }}><i class="fa-regular fa-comment fa-lg"></i><font className='mx-3'>comment</font></button>
                            </div>
                            <div style={{ float: "left", marginLeft: "20px" }}>
